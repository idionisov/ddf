// Mainframe macro generated from application: /cvmfs/sndlhc.cern.ch/SNDLHC-2024/June25/sw/slc9_x86-64/ROOT/v6-28-04-local1/bin/root.exe
// By ROOT version 6.28/04 on 2025-04-01 15:47:06
...
void Style_ddf()
{
   ...
   delete gROOT->GetStyle("ddf");

   TStyle *tmpStyle = new TStyle("ddf", "DDF Style");
   tmpStyle->SetNdivisions(610, "x");
   tmpStyle->SetNdivisions(610, "y");
   tmpStyle->SetNdivisions(610, "z");
   ...
   tmpStyle->SetLabelFont(102, "x");
   tmpStyle->SetLabelFont(102, "y");
   tmpStyle->SetLabelFont(102, "z");
