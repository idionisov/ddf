...
def _get_dataframe_TGraph_uproot(tgraph):
    """
    Converts an uproot TGraph to a pandas DataFrame.
    
    Parameters:
    TGraph: The uproot TGraph object to be converted.
    
    Returns:
    pandas.DataFrame: A DataFrame containing the values of the TGraph.
    """
    if not uproot.Model.is_instance(tgraph, "TGraph"):
        raise ValueError(f"{type(tgraph)} is not an uproot TGraph object!")
...
def _get_dataframe_TGraphErrors_uproot(tgraph):
    """
    Converts an uproot TGraphErrors to a pandas DataFrame.
    
    Parameters:
    TGraphErrors: The uproot TGraphErrors object to be converted.
...
def _get_dataframe_TGraphAsymmErrors_uproot(tgraph):
    """
